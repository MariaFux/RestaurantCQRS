namespace Restaurant.Controllers.V1
{
    ...
    public class MenusController : BaseController
    {
        ...
        {
            var result = await _mediator.Send(new GetAllMenus(), cancellationToken);
        ...
        [HttpPost]
        [ValidateModel]
        public async Task<IActionResult> CreateMenu([FromBody] MenuCreate newMenu, CancellationToken cancellationToken)
        {
        ...
        [Route(ApiRoutes.Menus.IdRoute)]
        [ValidateGuid("id")]
        public async Task<IActionResult> DeleteMenu(string id, CancellationToken cancellationToken)
        {
            var userProfileId = HttpContext.GetUserProfileIdClaimValue();
        ...
        [ValidateGuid("menuId")]
        public async Task<IActionResult> GetRecipesByMenuId(string menuId, CancellationToken cancellationToken)
        {
        ...
        [ValidateModel]
        public async Task<IActionResult> AddRecipeToMenu(string menuId, [FromQuery, BindRequired] string recipeId, CancellationToken cancellationToken)
        {
            var userProfileId = HttpContext.GetUserProfileIdClaimValue();
        ...
        [ValidateGuid("id")]
        [ValidateGuid("recipeId")]
        public async Task<IActionResult> RemoveRecipeFromMenu(string id, [FromQuery, BindRequired] string recipeId, CancellationToken cancellationToken)
        {
